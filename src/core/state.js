...
export function createGameState(width, height) {
  return {
    ...
    player: {
      ...
      move: 185, damage: 19, rate: .34, shots: 1, pierce: 0, magnet: 105, armor: 0, projectileSpeed: 710,
      slow: 0, crit: .06, dashCooldown: 3, dashDuration: .38, dash: 0, dashTime: 0, invulnerable: 0,
      shootTimer: 0, angle: 0,
    },
    entities: { bullets: [], enemyBullets: [], enemies: [], gems: [], heals: [], asteroids: [], mines: [], rings: [], particles: [], floaters: [] },
